...
def generate_scoped_combined_xml(df_01, df_15, scope, depr_key="ZSLM", fiscal_year="2026",
    ...
    for _, row01 in df_01.iterrows():
        ...
        for area, acq_val, dep_val in [("01", val_01_acq, val_01_dep), ("15", val_15_acq, val_15_dep)]:
            ...
            if cap_source_row is not None and cap_date_on_or_after(cap_source_row, cap_source_col, "2026-01-01"):
                continue
            cv_rows.append([
                comp_code, asset_key, sub_num, area, fiscal_year, acq_val, "", "",
                dep_val, "", "", "", "", "", "", currency,
            ])
    ...
    for _, row01 in df_01.iterrows():
        ...
        if dates and min(dates) >= parse_date_safe("2026-01-01"):
            continue
        pi_rows.append([comp, asset_key, sub_num, cap_final, "", "", "", ""])
    ...
    for _, row01 in df_01.iterrows():
        ...
        for area in ["01", "15"]:
            ...
            da_rows.append([
                comp, asset_key, sub_num, area, "", depr_key,
    ...
    for _, row01 in df_01.iterrows():
        ...
        for area in ["01", "15"]:
            ...
            pv_rows.append([
                comp, asset_key, sub_num, area, fiscal_year, "",
    ...
    for _, row01 in df_01.iterrows():
        ...
        for area in ["01", "15"]:
            ...
            tx_rows.append([comp, asset_key, sub_num, area, "100", fiscal_year, "1", ref_date_computed, amount_posted, currency])

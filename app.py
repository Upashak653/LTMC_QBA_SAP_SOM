...
def generate_scoped_combined_xml(df_01, df_15, scope, depr_key="ZSLM", fiscal_year="2026",
    ...
    cost_center_col = 8 if df_15.shape[1] > 8 else None  # literal Column I, per explicit instruction
    ...
    for _, row in df_15.iterrows():
        ...
        td_rows.append([get_val(row, c_comp), asset_key, sub_or_zero(row), "", cc_val] + [""] * (len(td_headers) - 5))
